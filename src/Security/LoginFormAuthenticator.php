...
class LoginFormAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function __construct(EditorRepository $editorRepository, UrlGeneratorInterface $urlGenerator, WriterRepository $writerRepository)
    {
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        $user = $token->getUser();
        // méthode alternative pour récupérer la liste des roles
        // $roles = $token->getRolesNames();
